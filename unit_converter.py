...
st.markdown(
    ...
    .stButton>button:hover {
        ...
        background: linear-gradient(45deg,rgb(190, 140, 199),rgb(126, 108, 139),rgb(112, 112, 160));
        color: white;
...
if st.button("🎰 Convert Now!"):
    ...
    st.markdown("<div class='footer'>Created by Yashfa Anwer</div>", unsafe_allow_html=True)
    st.balloons()